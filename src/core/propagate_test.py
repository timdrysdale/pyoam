...
class TestPropagate(unittest.TestCase):
    def test_two_element_el(self):
        ...
        plt.title('Two element pattern with half wavelength spacing - Elevation')
        plt.legend()
        plt.savefig('../../img/TestPropagateTwoElementPatternElevation.png',dpi=150)
    ...
    def test_two_element_az(self):
        ...
        plt.legend()
        plt.savefig('../../img/TestPropagateTwoElementPatternAzimuth.png',dpi=150)       
